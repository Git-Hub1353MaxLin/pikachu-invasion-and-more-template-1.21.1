             ...
             () -> new ArmorMaterial(Util.make(new EnumMap<>(ArmorItem.Type.class), map -> {
                map.put(ArmorItem.Type.BOOTS,2);
                 ...
                 map.put(ArmorItem.Type.BODY, 4);
                     ...
                     List.of(new ArmorMaterial.Layer(Identifier.of(PikachuInvasionAndMore.MOD_ID, "pink_garnet"))), 0, 0));

    public static RegistryEntry<ArmorMaterial> registerArmorMaterial(String name, Supplier<ArmorMaterial> material) {
        return Registry.registerReference(Registries.ARMOR_MATERIAL, Identifier.of(PikachuInvasionAndMore.MOD_ID, name), material.get());
    }
}
