...
public class GrowthChamberScreen extends HandledScreen<GrowthChamberScreenHandler> {
    private static final Identifier GUI_TEXTURE =
            Identifier.of(PikachuInvasionAndMore.MOD_ID, "textures/gui/growth_chamber/growth_chamber_gui.png");
    private static final Identifier ARROW_TEXTURE =
            Identifier.of(PikachuInvasionAndMore.MOD_ID, "textures/gui/arrow_progress.png");
