package net.maxlin.tutorialmod.sound;
...
public class ModSounds {
    ...
    public static final RegistryKey<JukeboxSong> BAR_BRAWL_KEY =
            RegistryKey.of(RegistryKeys.JUKEBOX_SONG, Identifier.of(PikachuInvasionAndMore.MOD_ID, "bar_brawl"));



    private static SoundEvent registerSoundEvent(String name) {
        Identifier id = Identifier.of(PikachuInvasionAndMore.MOD_ID, name);
