package net.maxlin.tutorialmod.entity.custom;
...
public class MantisEntity extends AnimalEntity {
    ...
    protected void initGoals() {
        ...
        this.goalSelector.add(2, new TemptGoal(this, 1.25D, Ingredient.ofItems(net.maxlin.tutorialmod.item.ModItems.CAULIFLOWER), false));
