...
import net.maxlin.tutorialmod.entity.custom.MantisVariant;
    ...
    private static final Map<MantisVariant, Identifier> LOCATION_BY_VARIANT =
            Util.make(Maps.newEnumMap(MantisVariant.class), map -> {
                map.put(MantisVariant.DEFAULT,
                        Identifier.of(PikachuInvasionAndMore.MOD_ID, "textures/entity/mantis/mantis.png"));
                map.put(MantisVariant.ORCHID,
                        Identifier.of(PikachuInvasionAndMore.MOD_ID, "textures/entity/mantis/mantis_orchid.png"));
            });
