package net.maxlin.tutorialmod.entity.client;
...
public class TomahawkProjectileRenderer extends EntityRenderer<TomahawkProjectileEntity> {
    ...
    public void render(TomahawkProjectileEntity entity, float yaw, float tickDelta, MatrixStack matrices,
        ...
        if(!entity.isGrounded()) {
            ...
            if (entity.groundedOffset == null) {
                entity.groundedOffset = new Vector2f(0, 0);
            }
        ...
        VertexConsumer vertexconsumer = ItemRenderer.getDirectItemGlintConsumer(vertexConsumers,
                this.model.getLayer(Identifier.of(PikachuInvasionAndMore.MOD_ID, "textures/entity/tomahawk/tomahawk.png")), false, false);
    ...
    public Identifier getTexture(TomahawkProjectileEntity entity) {
        return Identifier.of(PikachuInvasionAndMore.MOD_ID, "textures/entity/tomahawk/tomahawk.png");
    }
}
